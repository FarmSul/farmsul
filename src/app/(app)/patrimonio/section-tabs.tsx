...
const TABS = [
  { key: "visao-geral", href: "/patrimonio", label: "Visão Geral" },
  { key: "ativos", href: "/patrimonio/ativos", label: "Ativos" },
  { key: "manutencao", href: "/patrimonio/manutencao", label: "Manutenção" },
  { key: "abastecimento", href: "/patrimonio/abastecimento", label: "Abastecimento" },
];
