...
const TABS = [
  { key: "estoque", href: "/estoque-insumos", label: "Estoque" },
  { key: "movimentacoes", href: "/estoque-insumos/movimentacoes", label: "Movimentações" },
];

export function SectionTabs() {
  const pathname = usePathname();
  const current = TABS.find((t) => t.href === pathname)?.key ?? "estoque";
